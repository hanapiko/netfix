...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        sample_companies = [
            ...
            {
                'username': 'green_gardens',
                'email': 'greengardens@gmail.com',
        ...
        for company_data in sample_companies:
            user, created = User.objects.get_or_create(
                ...
                defaults={
                    ...
                    'field_of_work': company_data['field_of_work'],
            ...
            if created:
                ...
                user.save()
                self.stdout.write(f'Created company user: {user.username}')
        ...
        sample_services = [
            ...
            },
            {
                ...
                'description': 'Transform your outdoor space with our professional garden design and landscaping services. From concept to completion.',
                'field': 'GARDENING',
                'price_per_hour': Decimal('35.00'),
                'company_username': 'green_gardens'
            }
        ]
